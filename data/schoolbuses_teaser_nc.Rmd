...
****
How many trips were logged the week of October 8 2013, the day when bus drivers went on strike?
```{r, results='asis', fig.width=10, fig.height=3, warning=FALSE, message=FALSE}
rawdata %>%
  ...
  ggtitle('Number of trips per day for October 2013') +
  xlab('day') +
  ylab('number of trips')
```

****
How many trips arrived on time during the same period?
```{r, results='asis', fig.width=10, fig.height=3, warning=FALSE, message=FALSE}
late %>%
  filter(
    year(date) == 2013,
  ...
  geom_bar(stat='identity', position='dodge') +
  ggtitle('Percent of tardy buses by various definitions of "late" for October 2013') +
  scale_y_continuous(labels=percent) +
  theme(axis.title.y = element_blank()) +
  xlab('day')
```
